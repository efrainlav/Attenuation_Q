...
% ParÃ¡metros del usuario para generar el diccionario
	...
	f2=250; % Frecuencia final
	ph1=-180; % Fase inicial en grados
	ph2=180; % Fase final en grados
	ns=1000; % Numero de muestras para una tasa de muestreo de 2 ms
	...
	savefile = 'diccionario_VSP_QF5.mat'; % Crea un archivo para guardar el diccionario
